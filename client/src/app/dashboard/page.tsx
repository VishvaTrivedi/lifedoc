...
import { FaHeartbeat, FaTint, FaWeight, FaCalendarCheck, FaMicrophone, FaPrescriptionBottleAlt, FaCamera, FaRobot } from 'react-icons/fa';
            ...
            <div className="flex min-h-screen">
                ...
                <main className="flex-1 ml-72 p-8">
                    <header className="mb-8 flex justify-between items-end">
                        ...
                        <div className="glass px-6 py-2 rounded-full text-sm font-semibold text-gray-500">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
                        ...
                        <Link href="/scan" className="group relative overflow-hidden rounded-2xl bg-white border border-gray-100 p-8 flex flex-col justify-between hover:border-[#7A8E6B]/30 hover:shadow-md transition-all duration-300">
                                ...
                                {measurements.slice(0, 3).map((m, i) => (
                                    <div key={i} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                                        <div className="flex items-center">
                                            <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-sm mr-4 text-gray-400">
                                                <FaCalendarCheck />
                                            </div>
                                            <div>
